...
public class CoralBuilderOpti {
	...
	ArrayList<CoralOpti> coralList = new ArrayList<CoralOpti>();   
	...
	CoralBuilderOpti(TimeKeeperOpti tk) {

		reefNumber = tk.getReefNumber();
		siteCover = RecruitmentMainOpti.getSiteCoverArray()[reefNumber]; 
		sizeFreqArray = RecruitmentMainOpti.getSizeFreqArray();
