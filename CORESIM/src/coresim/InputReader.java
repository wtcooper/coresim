...
public class InputReader {
	...
	private static final double[][] paramArrayDoubles = new double[7][3]; 
	...
	void processLineParameters(String aLine){
		...
		if ( scanner.hasNext() ){
			...
			if (loopCounter == 0){
				...
				String temp = scanner.next(); // do nothing with this; is string of param name
					int startValue = scanner.nextInt();
					int endValue = scanner.nextInt();
					int step = scanner.nextInt();
					paramArray[loopCounter-3][0] = startValue;
					paramArray[loopCounter-3][1] = endValue;
					paramArray[loopCounter-3][2] = step;
			}

			else if (loopCounter > 7 ){
				String temp = scanner.next(); // do nothing with this; is string of param name
					double startValue = scanner.nextFloat();
					double endValue = scanner.nextFloat();
					double step = scanner.nextFloat();
					paramArrayDoubles[loopCounter-8][0] = startValue;
					paramArrayDoubles[loopCounter-8][1] = endValue;
					paramArrayDoubles[loopCounter-8][2] = step;
